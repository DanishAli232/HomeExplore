...
// send email
mail("balochdanish2020@gmail.com","My subject",$msg);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $reenter = test_input($_POST["re-enter"]);
  ...
  $sql = "INSERT INTO AddressUser(Name, Email, PhoneNo, HomeAddress) VALUES ('$name','$email','$password1', '$reenter')";
